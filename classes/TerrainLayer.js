export let log = (...args) => console.log("terrainlayer2 | ", ...args);
//TERRAIN LAYER
...
export class TerrainLayer extends CanvasLayer{
    ...
    */
    ...
    highlightGridPosition(layer , {gridX, gridY, multiple=2,type='ground'}={}) {
        ...
        */
        /*
        terrainSquare.moveTo((gsW / 2), 0);
        terrainSquare.lineTo(0, (gsH / 2));
        terrainSquare.moveTo(gsW, 0);
        terrainSquare.lineTo(0, gsH);
        terrainSquare.moveTo(gsW, (gsH / 2));
        terrainSquare.lineTo((gsW / 2), gsH);*/

        terrainSquare.beginFill(0xffffff, 0.5);
        terrainSquare.lineStyle(1, 0xffffff, 0.5);
        terrainSquare.drawPolygon([0, 0, 5, 0, 0, 5]);
        terrainSquare.drawPolygon([(gsW / 2) - 5, 0, (gsW / 2) + 5, 0, 0, (gsH / 2) + 5, 0, (gsH / 2) - 5]);
        terrainSquare.drawPolygon([gsW, 0, gsW, 5, 5, gsH, 0, gsH, 0, gsH - 5, gsW - 5, 0]);
        terrainSquare.drawPolygon([gsW, (gsH / 2) - 5, gsW, (gsH / 2) + 5, (gsW / 2) + 5, gsH, (gsW / 2) - 5, gsH]);
        terrainSquare.drawPolygon([gsW, gsH, gsW - 5, gsH, gsW, gsH - 5]);
